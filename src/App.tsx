...
function App() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen  via-[#D496A7] flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#d58a9e]"></div>
      </div>
    );
  }
  ...
  return (
    <div
      className="min-h-screen bg-[#F1DEDE]"
      style={{
    ...
    >
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-1/2 -right-1/2 w-96 h-96  bg-[#D496A7]  hover:shadow-xl transform hover:scale-105 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-1/2 -left-1/2 w-96 h-96   bg-[#D496A7]  hover:shadow-xl transform hover:scale-105 rounded-full blur-3xl"></div>
      </div>
    </div>
  );
}
